...
# Fig: is basically the paper or window as it holds everything
# Axs: are the stickers or the plots, it is the list (array) of the 4 graphs
...
# Unlike plt.plot() which just draws on the "current" active window
# here we specify EXACTLY which square we want to paint on
...
# fig.suptitle: Sets the main title for the entire "Paper"
fig.suptitle('DASHBOARD', fontsize=18, fontweight='bold', color='#111')

# Tight Layout prevents the graphs from overlapping each other
# plt.tight_layout(): CRITICAL COMMAND
# Without this, the axis labels of the top row would overlap 
# with the titles of the bottom row This function calculates
# the perfect padding automatically
plt.tight_layout()
